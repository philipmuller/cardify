...
export function PreviewDisplay({
  ...
  const isHinting = () => {
    return state == PreviewDisplayState.hint;
  };
  const isMobile = () => {
  ...
  const hintXOffsetsDesktop = [
    hintCardSpacingDesktop,
    0,
    -hintCardSpacingDesktop,
  ];
  ...
  return (
    <div className="flex shrink basis-3/4 flex-row items-center justify-center pb-14 pt-20">
      {displayCards()}
    </div>
  );
}
