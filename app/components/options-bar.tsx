...
export default function OptionsBar( { isHoveringFile, isStartingShortcut, breakpoint }: { isHoveringFile: boolean, isStartingShortcut: boolean, breakpoint: Breakpoint }) {
    ...
    return (
        <div className="flex flex-row justify-center gap-4 basis-1/4 px-5 fixed w-full bottom-10 md:bottom-0 md:relative text-sm md:text-xl text-stone-400 dark:text-stone-500 text-center px-20">
